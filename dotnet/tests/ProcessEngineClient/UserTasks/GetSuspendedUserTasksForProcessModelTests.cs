namespace ProcessEngine.Client.Tests
{
    ...
    public class GetSuspendedUserTasksForProcessModelTests : ProcessEngineBaseTest
    {
        private readonly ProcessEngineClientFixture fixture;

        public GetSuspendedUserTasksForProcessModelTests(ProcessEngineClientFixture fixture)
        {
            this.fixture = fixture;
        }

        [Fact]
        public async Task BPMN_GetSuspendedUserTasksForProcessModel_ShouldFetchUserTaskList()
        {
            ...
            var userTasks = await this
                .fixture
                .ProcessEngineClient
                .GetSuspendedUserTasksForProcessModel(processModelId);
