namespace ProcessEngine.Client.Tests
{
    ...
    public class GetSuspendedEmptyActivitiesForProcessModelInCorrelationTests : ProcessEngineBaseTest
    {
        private readonly ProcessEngineClientFixture fixture;

        public GetSuspendedEmptyActivitiesForProcessModelInCorrelationTests(ProcessEngineClientFixture fixture)
        {
            this.fixture = fixture;
        }

        [Fact]
        public async Task BPMN_GetSuspendedEmptyActivitiesForProcessModelInCorrelation_ShouldFetchEmptyActivityList()
        {
