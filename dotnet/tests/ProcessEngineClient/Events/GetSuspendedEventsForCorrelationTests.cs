namespace ProcessEngine.Client.Tests
{
    ...
    public class GetSuspendedEventsForCorrelationTests : ProcessEngineBaseTest
    {
        private readonly ProcessEngineClientFixture fixture;

        public GetSuspendedEventsForCorrelationTests(ProcessEngineClientFixture fixture)
        {
            this.fixture = fixture;
        }

        [Fact]
        public async Task BPMN_GetSuspendedEventsForCorrelationTests_ShouldFetchEventsOfRunningProcess()
        {
            ...
            var events = await this
                .fixture
                .ProcessEngineClient
                .GetSuspendedEventsForCorrelation(processStartResponsePayload.CorrelationId);
